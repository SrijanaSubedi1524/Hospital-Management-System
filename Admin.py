...
class Admin:
    ...
    def get_doctor_details(self) :
        ...
        """
        first_name = input("Enter the name first name of the doctor: ")
    ...
    def doctor_management(self, doctors):
        ...
        # Update
            ...
            if op == "1":
                ...
                doctors[index-1].set_first_name(first_name)
            elif op == "2":
                surname = input("Enter surname: ")
                doctors[index-1].set_surname(surname)
            elif op == "3":
                speciality = input("Enter specilaity: ")
                doctors[index-1].set_speciality(speciality)
            else:
    ...
    def write_patient_records(patients):
        file_name = 'patient.txt'
    ...
    def discharge(self, patients, discharged_patients):
        ...
        try:
            ...
            print (f'Discharged patient sucessfully!')
            #ToDo12
        ...
        try:
            if op =='1':
                ...
                for i in range(len(pair_list)+1):
                    ...
                    plt.bar(symptom, total_patients, color='lightcoral')
